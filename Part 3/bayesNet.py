...
class BayesNet(object):
    ...
    def sameGraph(self, other):
        ...
        sameDomain = sorted(self.__variableDomainsDict.items()) == sorted(other.__variableDomainsDict.items())
        sameInEdges = sorted(self.__inEdges.items()) == sorted(other.__inEdges.items())
        sameOutEdges = sorted(self.__outEdges.items()) == sorted(other.__outEdges.items())
        return sameVars and sameInEdges and sameOutEdges and sameDomain
